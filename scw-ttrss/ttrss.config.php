<?php
	...
	define('SELF_URL_PATH', 'http://' . getenv('VIRTUAL_HOST'));
	...
	// if necessary (after migrating all new options from this file).
        ...
        if (!file_exists("/tmp/ttrss_db_initialized.txt")) {
           $fp = fopen("/tmp/ttrss_db_initialized.txt", "w");

           require_once "configure-db.php";

           configure_db_initialize(DB_HOST, DB_USER, DB_PASS, DB_NAME, DB_PORT);
