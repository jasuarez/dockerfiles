...
CREATE TABLE DATABASECHANGELOGLOCK (ID INT NOT NULL, LOCKED SMALLINT NOT NULL, LOCKGRANTED TIMESTAMP NULL, LOCKEDBY VARCHAR(255) NULL, CONSTRAINT PK_DATABASECHANGELOGLOCK PRIMARY KEY (ID));

INSERT INTO DATABASECHANGELOGLOCK (ID, LOCKED) VALUES (1, 0);

--  Lock Database
--  Create Database Change Log Table
CREATE TABLE DATABASECHANGELOG (ID VARCHAR(63) NOT NULL, AUTHOR VARCHAR(63) NOT NULL, FILENAME VARCHAR(200) NOT NULL, DATEEXECUTED TIMESTAMP NOT NULL, ORDEREXECUTED INT NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35) NULL, DESCRIPTION VARCHAR(255) NULL, COMMENTS VARCHAR(255) NULL, TAG VARCHAR(255) NULL, LIQUIBASE VARCHAR(20) NULL, CONSTRAINT PK_DATABASECHANGELOG PRIMARY KEY (ID, AUTHOR, FILENAME));
...
CREATE TABLE advance_assignment (id BIGINT NOT NULL, version BIGINT NOT NULL, report_global_advance SMALLINT NULL, advance_type_id BIGINT NULL, CONSTRAINT advance_assignment_pkey PRIMARY KEY (id));
...
CREATE TABLE advance_assignment_template (id BIGINT NOT NULL, version BIGINT NOT NULL, advance_type_id BIGINT NULL, order_element_template_id BIGINT NULL, report_global_advance SMALLINT NULL, max_value DECIMAL(19,2) NULL, CONSTRAINT advance_assignment_template_pkey PRIMARY KEY (id));
...
CREATE TABLE advance_measurement (id BIGINT NOT NULL, version BIGINT NOT NULL, date DATE NULL, value DECIMAL(19,2) NULL, advance_assignment_id BIGINT NULL, communication_date TIMESTAMP NULL, CONSTRAINT advance_measurement_pkey PRIMARY KEY (id));
...
CREATE TABLE advance_type (id BIGINT NOT NULL, version BIGINT NOT NULL, unit_name VARCHAR(255) NULL, default_max_value DECIMAL(19,4) NULL, updatable SMALLINT NULL, unit_precision DECIMAL(19,4) NULL, active SMALLINT NULL, percentage SMALLINT NULL, quality_form SMALLINT NULL, CONSTRAINT advance_type_pkey PRIMARY KEY (id));
...
CREATE TABLE base_calendar (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, code_autogenerated SMALLINT NULL, last_sequence_code INT NULL, CONSTRAINT base_calendar_pkey PRIMARY KEY (id));
...
CREATE TABLE calendar_exception_type (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, code_autogenerated SMALLINT NOT NULL, name VARCHAR(255) NULL, color VARCHAR(255) NULL, not_assignable SMALLINT NULL, duration INT NULL, CONSTRAINT calendar_exception_type_pkey PRIMARY KEY (id));
...
CREATE TABLE configuration (id BIGINT NOT NULL, version BIGINT NOT NULL, configuration_id BIGINT NULL, company_code VARCHAR(255) NULL, generate_code_for_cost_category SMALLINT NOT NULL, generate_code_for_calendar_exception_type SMALLINT NOT NULL, generate_code_for_work_report_type SMALLINT NOT NULL, generate_code_for_criterion SMALLINT NOT NULL, generate_code_for_label SMALLINT NOT NULL, generate_code_for_work_report SMALLINT NOT NULL, generate_code_for_resources SMALLINT NOT NULL, generate_code_for_types_of_work_hours SMALLINT NOT NULL, generate_code_for_material_categories SMALLINT NOT NULL, generate_code_for_unit_types SMALLINT NOT NULL, generate_code_for_base_calendars SMALLINT NOT NULL, expand_company_planning_view_charts SMALLINT NOT NULL, expand_order_planning_view_charts SMALLINT NOT NULL, expand_resource_load_view_charts SMALLINT NOT NULL, monte_carlo_method_tab_visible SMALLINT NOT NULL, progress_type INT NULL, CONSTRAINT configuration_pkey PRIMARY KEY (id));
...
CREATE TABLE cost_category (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, code_autogenerated SMALLINT NOT NULL, last_hour_cost_sequence_code INT NOT NULL, enabled SMALLINT NULL, CONSTRAINT cost_category_pkey PRIMARY KEY (id));
...
CREATE TABLE criterion (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, predefined_criterion_internal_name VARCHAR(255) NULL, active SMALLINT NULL, id_criterion_type BIGINT NOT NULL, parent BIGINT NULL, CONSTRAINT criterion_pkey PRIMARY KEY (id));
...
CREATE TABLE criterion_satisfaction (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, start_date TIMESTAMP NOT NULL, finish_date TIMESTAMP NULL, is_deleted SMALLINT NULL, criterion BIGINT NOT NULL, resource BIGINT NOT NULL, CONSTRAINT criterion_satisfaction_pkey PRIMARY KEY (id));
...
CREATE TABLE day_assignment (id BIGINT NOT NULL, day_assignment_type VARCHAR(255) NOT NULL, version BIGINT NOT NULL, duration INT NOT NULL, consolidated SMALLINT NULL, day DATE NOT NULL, resource_id BIGINT NOT NULL, specific_container_id BIGINT NULL, generic_container_id BIGINT NULL, derived_container_id BIGINT NULL, CONSTRAINT day_assignment_pkey PRIMARY KEY (id));
...
CREATE TABLE entity_sequence (id BIGINT NOT NULL, version BIGINT NOT NULL, entity_name INT NULL, prefix VARCHAR(255) NULL, last_value INT NULL, number_of_digits INT NULL, active SMALLINT NULL, CONSTRAINT entity_sequence_pkey PRIMARY KEY (id));
...
CREATE TABLE external_company (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, nif VARCHAR(255) NULL, client SMALLINT NULL, subcontractor SMALLINT NULL, interacts_with_applications SMALLINT NULL, app_uri VARCHAR(255) NULL, our_company_login VARCHAR(255) NULL, our_company_password VARCHAR(255) NULL, company_user BIGINT NULL, CONSTRAINT external_company_pkey PRIMARY KEY (id));
...
CREATE TABLE label_type (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, code_autogenerated SMALLINT NOT NULL, last_label_sequence_code INT NULL, CONSTRAINT label_type_pkey PRIMARY KEY (id));
...
CREATE TABLE limiting_resource_queue_element (id BIGINT NOT NULL, version BIGINT NOT NULL, resource_allocation_id BIGINT NULL, limiting_resource_queue_id BIGINT NULL, earlier_start_date_because_of_gantt TIMESTAMP NULL, earliest_end_date_because_of_gantt TIMESTAMP NULL, creation_timestamp BIGINT NULL, start_date DATE NULL, start_hour INT NULL, end_date DATE NULL, end_hour INT NULL, CONSTRAINT limiting_resource_queue_element_pkey PRIMARY KEY (id));
...
CREATE TABLE machine_worker_assignment (id BIGINT NOT NULL, version BIGINT NOT NULL, start_date TIMESTAMP NULL, finish_date TIMESTAMP NULL, configuration_id BIGINT NOT NULL, worker_id BIGINT NULL, CONSTRAINT machine_worker_assignment_pkey PRIMARY KEY (id));
...
CREATE TABLE material (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, description VARCHAR(255) NULL, default_unit_price DECIMAL(19,2) NULL, unit_type BIGINT NULL, disabled SMALLINT NULL, category_id BIGINT NULL, CONSTRAINT material_pkey PRIMARY KEY (id));
...
CREATE TABLE material_assigment (id BIGINT NOT NULL, version BIGINT NOT NULL, units DECIMAL(19,2) NULL, unit_price DECIMAL(19,2) NULL, material_id BIGINT NULL, estimated_availability TIMESTAMP NULL, status INT NULL, order_element_id BIGINT NULL, CONSTRAINT material_assigment_pkey PRIMARY KEY (id));
...
CREATE TABLE material_category (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, code_autogenerated SMALLINT NOT NULL, last_material_sequence_code INT NOT NULL, parent_id BIGINT NULL, CONSTRAINT material_category_pkey PRIMARY KEY (id));
...
CREATE TABLE order_element (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, description VARCHAR(255) NULL, code VARCHAR(255) NULL, init_date TIMESTAMP NULL, deadline TIMESTAMP NULL, last_advance_meausurement_for_spreading DECIMAL(19,2) NULL, dirty_last_advance_measurement_for_spreading SMALLINT NULL, parent BIGINT NULL, template BIGINT NULL, external_code VARCHAR(255) NULL, sum_charged_hours_id BIGINT NULL, position_in_container INT NULL, CONSTRAINT order_element_pkey PRIMARY KEY (id));
...
CREATE TABLE order_table (order_element_id BIGINT NOT NULL, responsible VARCHAR(255) NULL, dependencies_constraints_have_priority SMALLINT NULL, code_autogenerated SMALLINT NULL, last_order_element_sequence_code INT NULL, work_budget DECIMAL(19,2) NULL, materials_budget DECIMAL(19,2) NULL, total_hours INT NULL, customer_reference VARCHAR(255) NULL, external_code VARCHAR(255) NULL, state INT NULL, customer BIGINT NULL, base_calendar_id BIGINT NULL, CONSTRAINT order_table_pkey PRIMARY KEY (order_element_id));
...
CREATE TABLE order_version (id BIGINT NOT NULL, version BIGINT NOT NULL, modification_by_owner_timestamp TIMESTAMP NULL, ownerscenario BIGINT NULL, CONSTRAINT order_version_pkey PRIMARY KEY (id));
...
CREATE TABLE quality_form (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, description VARCHAR(255) NULL, quality_form_type INT NULL, report_advance SMALLINT NULL, advance_type_id BIGINT NULL, CONSTRAINT quality_form_pkey PRIMARY KEY (id));
...
CREATE TABLE resource (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, code_autogenerated SMALLINT NOT NULL, limited_resource SMALLINT NOT NULL, base_calendar_id BIGINT NULL, CONSTRAINT resource_pkey PRIMARY KEY (id));
...
CREATE TABLE scenario (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, description VARCHAR(255) NULL, last_not_owned_reassignations_time_stamp TIMESTAMP NULL, predecessor BIGINT NULL, CONSTRAINT scenario_pkey PRIMARY KEY (id));
...
CREATE TABLE subcontracted_task_data (id BIGINT NOT NULL, version BIGINT NOT NULL, external_company BIGINT NULL, subcontratation_date TIMESTAMP NULL, subcontract_communication_date TIMESTAMP NULL, work_description VARCHAR(255) NULL, subcontract_price DECIMAL(19,2) NULL, subcontracted_code VARCHAR(255) NULL, node_without_children_exported SMALLINT NULL, labels_exported SMALLINT NULL, material_assignments_exported SMALLINT NULL, hours_groups_exported SMALLINT NULL, state INT NULL, CONSTRAINT subcontracted_task_data_pkey PRIMARY KEY (id));
...
CREATE TABLE task_quality_form (id BIGINT NOT NULL, version BIGINT NOT NULL, quality_form_id BIGINT NULL, order_element_id BIGINT NULL, report_advance SMALLINT NULL, CONSTRAINT task_quality_form_pkey PRIMARY KEY (id));
...
CREATE TABLE task_quality_form_items (task_quality_form_id BIGINT NOT NULL, name VARCHAR(255) NULL, percentage DECIMAL(19,2) NULL, position INT NULL, passed SMALLINT NULL, date TIMESTAMP NULL, idx INT NOT NULL);
...
CREATE TABLE type_of_work_hours (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, code VARCHAR(255) NULL, default_price DECIMAL(19,2) NULL, enabled SMALLINT NULL, code_autogenerated SMALLINT NOT NULL, CONSTRAINT type_of_work_hours_pkey PRIMARY KEY (id));
...
CREATE TABLE unit_type (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, measure VARCHAR(255) NULL, code_autogenerated SMALLINT NOT NULL, CONSTRAINT unit_type_pkey PRIMARY KEY (id));
...
CREATE TABLE user_table (id BIGINT NOT NULL, version BIGINT NOT NULL, login_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NULL, disabled SMALLINT NULL, lastconnectedscenario BIGINT NULL, CONSTRAINT user_table_pkey PRIMARY KEY (id));
...
CREATE TABLE work_report (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, date TIMESTAMP NULL, code_autogenerated SMALLINT NOT NULL, last_work_report_line_sequence_code INT NULL, ork_report_type_id BIGINT NOT NULL, resource_id BIGINT NULL, order_element_id BIGINT NULL, CONSTRAINT work_report_pkey PRIMARY KEY (id));
...
CREATE TABLE work_report_label_type_assigment (id BIGINT NOT NULL, version BIGINT NOT NULL, labels_shared_by_lines SMALLINT NULL, position_number INT NULL, label_type_id BIGINT NULL, label_id BIGINT NULL, work_report_type_id BIGINT NULL, CONSTRAINT work_report_label_type_assigment_pkey PRIMARY KEY (id));
...
CREATE TABLE work_report_line (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, num_hours INT NULL, date TIMESTAMP NULL, clock_start INT NULL, clock_finish INT NULL, work_report_id BIGINT NULL, resource_id BIGINT NOT NULL, order_element_id BIGINT NOT NULL, type_work_hours_id BIGINT NOT NULL, CONSTRAINT work_report_line_pkey PRIMARY KEY (id));
...
CREATE TABLE work_report_type (id BIGINT NOT NULL, version BIGINT NOT NULL, name VARCHAR(255) NULL, code VARCHAR(255) NULL, date_is_shared_by_lines SMALLINT NULL, resource_is_shared_in_lines SMALLINT NULL, order_element_is_shared_in_lines SMALLINT NULL, code_autogenerated SMALLINT NOT NULL, hours_management INT NULL, CONSTRAINT work_report_type_pkey PRIMARY KEY (id));
...
ALTER TABLE configuration ADD scenarios_visible SMALLINT;
...
ALTER TABLE configuration ADD changed_default_admin_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_admin_password SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD changed_default_user_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_user_password SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD changed_default_wsreader_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_wsreader_password SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD changed_default_wswriter_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_wswriter_password SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD ldap_save_password_db SMALLINT;
...
ALTER TABLE configuration ADD ldap_auth_enabled SMALLINT;
...
ALTER TABLE user_table ADD navalplan_user SMALLINT;
...
ALTER TABLE user_table MODIFY navalplan_user SMALLINT NOT NULL;
...
ALTER TABLE configuration MODIFY ldap_save_password_db SMALLINT NOT NULL;
...
ALTER TABLE configuration MODIFY ldap_auth_enabled SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD ldap_save_roles_db SMALLINT;
...
ALTER TABLE configuration MODIFY ldap_save_roles_db SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD enabled_autocomplete_login SMALLINT;
...
ALTER TABLE configuration MODIFY enabled_autocomplete_login SMALLINT NOT NULL;
...
ALTER TABLE user_table ADD expand_company_planning_view_charts SMALLINT;
...
ALTER TABLE user_table MODIFY expand_company_planning_view_charts SMALLINT NOT NULL;

ALTER TABLE user_table ADD expand_order_planning_view_charts SMALLINT;
...
ALTER TABLE user_table MODIFY expand_order_planning_view_charts SMALLINT NOT NULL;

ALTER TABLE user_table ADD expand_resource_load_view_charts SMALLINT;
...
ALTER TABLE user_table MODIFY expand_resource_load_view_charts SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD ldap_group_strategy SMALLINT;
...
ALTER TABLE configuration MODIFY ldap_group_strategy SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD check_new_version_enabled SMALLINT;
...
ALTER TABLE configuration MODIFY check_new_version_enabled SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD allow_to_gather_usage_stats_enabled SMALLINT;
...
ALTER TABLE configuration MODIFY allow_to_gather_usage_stats_enabled SMALLINT NOT NULL;
...
CREATE TABLE customer_comunication (id BIGINT NOT NULL, version BIGINT NOT NULL, deadline TIMESTAMP NULL, comunication_type INT NULL, comunication_date TIMESTAMP NULL, reviewed SMALLINT NULL, order_id BIGINT NULL, CONSTRAINT customer_comunication_pkey PRIMARY KEY (id));
...
CREATE TABLE subcontractor_comunication (id BIGINT NOT NULL, version BIGINT NOT NULL, comunication_type INT NULL, comunication_date TIMESTAMP NULL, reviewed SMALLINT NULL, subcontracted_task_data BIGINT NULL, CONSTRAINT subcontractor_comunication_pkey PRIMARY KEY (id));
...
CREATE TABLE subcontrator_comunication_values (subcontractor_comunication_id BIGINT NOT NULL, date TIMESTAMP NULL, progress DECIMAL(19,2) NULL, idx INT NOT NULL);
...
ALTER TABLE customer_communication CHANGE comunication_date communication_date TIMESTAMP;
...
--  Rename column comunication_date to communication_date
ALTER TABLE subcontractor_communication CHANGE comunication_date communication_date TIMESTAMP;
...
CREATE TABLE deadline_communication (id BIGINT NOT NULL, version BIGINT NOT NULL, save_date TIMESTAMP NULL, deliver_date TIMESTAMP NULL, CONSTRAINT deadline_comunication_pkey PRIMARY KEY (id));
...
CREATE TABLE subcontractor_deliver_date (id BIGINT NOT NULL, version BIGINT NOT NULL, save_date TIMESTAMP NULL, subcontractor_deliver_date TIMESTAMP NULL, communication_date TIMESTAMP NULL, CONSTRAINT subcontrator_deliver_date_pkey PRIMARY KEY (id));
...
CREATE TABLE end_date_communication_to_customer (id BIGINT NOT NULL, version BIGINT NOT NULL, save_date TIMESTAMP NULL, end_date TIMESTAMP NULL, communication_date TIMESTAMP NULL, order_id BIGINT NULL, CONSTRAINT end_date_communication_to_customer_pkey PRIMARY KEY (id));
...
CREATE TABLE expense_sheet (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, code_autogenerated SMALLINT NULL, first_expense TIMESTAMP NULL, last_expense TIMESTAMP NULL, total DECIMAL(19,2) NULL, description LONGTEXT NULL, last_expense_sheet_line_sequence_code INT NULL, CONSTRAINT expense_sheet_pkey PRIMARY KEY (id));
...
CREATE TABLE expense_sheet_line (id BIGINT NOT NULL, version BIGINT NOT NULL, code VARCHAR(255) NOT NULL, value DECIMAL(19,2) NULL, concept VARCHAR(255) NULL, date TIMESTAMP NULL, order_element_id BIGINT NULL, resource_id BIGINT NULL, expense_sheet_id BIGINT NULL, CONSTRAINT expense_sheet_line_pkey PRIMARY KEY (id));
...
ALTER TABLE configuration ADD generate_code_for_expense_sheets SMALLINT;
...
ALTER TABLE configuration MODIFY generate_code_for_expense_sheets SMALLINT NOT NULL;
...
ALTER TABLE configuration ADD changed_default_wssubcontracting_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_wssubcontracting_password SMALLINT NOT NULL;
...
--              default value FALSE to configuration table
ALTER TABLE configuration ADD changed_default_manager_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_manager_password SMALLINT NOT NULL;
...
--              default value FALSE to configuration table
ALTER TABLE configuration ADD changed_default_hresources_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_hresources_password SMALLINT NOT NULL;
...
--              default value FALSE to configuration table
ALTER TABLE configuration ADD changed_default_outsourcing_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_outsourcing_password SMALLINT NOT NULL;
...
--              default value FALSE to configuration table
ALTER TABLE configuration ADD changed_default_reports_password SMALLINT;
...
ALTER TABLE configuration MODIFY changed_default_reports_password SMALLINT NOT NULL;
...
ALTER TABLE sum_charged_effort ADD first_timesheet_date TIMESTAMP;

ALTER TABLE sum_charged_effort ADD last_timesheet_date TIMESTAMP;
...
--              sum_charged_effort table.
ALTER TABLE sum_charged_effort ADD finished_timesheets SMALLINT;
...
ALTER TABLE sum_charged_effort MODIFY finished_timesheets SMALLINT NOT NULL;
...
--              task_element table.
ALTER TABLE task_element ADD updated_from_timesheets SMALLINT;
...
ALTER TABLE task_element MODIFY updated_from_timesheets SMALLINT NOT NULL;
...
ALTER TABLE calendar_exception_type ADD updatable SMALLINT;
...
ALTER TABLE calendar_exception_type MODIFY updatable SMALLINT NOT NULL;
...
CREATE TABLE order_sync_info (id BIGINT NOT NULL, version BIGINT NOT NULL, last_sync_date TIMESTAMP NOT NULL, key VARCHAR(255) NOT NULL, connector_name VARCHAR(255) NOT NULL, order_element_id BIGINT NULL, CONSTRAINT PK_ORDER_SYNC_INFO PRIMARY KEY (id));
...
CREATE TABLE job_scheduler_configuration (id BIGINT AUTO_INCREMENT NOT NULL, version BIGINT NOT NULL, job_group VARCHAR(255) NOT NULL, job_name VARCHAR(255) NOT NULL, cron_expression VARCHAR(255) NOT NULL, job_class_name INT NOT NULL, connector_name VARCHAR(255) NULL, schedule SMALLINT NULL, CONSTRAINT PK_JOB_SCHEDULER_CONFIGURATION PRIMARY KEY (id));
